...
# print(matches.head())
name_change= {"Delhi Daredevils": "Delhi Capitals",
              'Kings XI Punjab': "Punjab Kings",
              'Rising Pune Supergiant':'Rising Pune Supergiants',
              "Deccan Chargers" : "Sunrisers Hyderabad"}
matches.replace(name_change.keys(),name_change.values(),inplace = True)
def teamsapi():
    teams =  list(set(list(matches["Team1"]) + list(matches["Team1"])))
    team_dict = {
        "teams" : teams
    }
    return team_dict
